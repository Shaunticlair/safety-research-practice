...
2. Edit `slides.md`. Keep the two slides, one for Q1 and one for Q2. Replace the graph placeholder with an image tag as shown in the file. Use short notes that support your spoken explanation.
...
The slides are working material for your recording and do not need a separate submission. Keep them locally with their linked images. The final submission is the small reproduction-code/AI-log ZIP and an unlisted YouTube link; leave the video file out of the ZIP.
